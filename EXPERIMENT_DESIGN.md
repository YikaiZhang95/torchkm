...
| Grid | 50 log-uniform λ from 1e-1 down to 1e-5 (the paper's grid, swept large to small), identical for every dataset; TorchKM and cuML receive C = 1/(2nλ) with n the rows of the fit; epochs 1..50 for EigenPro |
